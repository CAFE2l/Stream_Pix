        ...
        <div className="w-full max-w-sm">
          <div className="glass p-8">
            ...
            <div className="text-center mb-8">
              ...
              <h2 className="text-xl font-bold text-offwhite tracking-tight">Bem-vindo de volta</h2>
              <p className="mt-1.5 text-sm text-sage">Entre na sua conta para continuar</p>
            </div>
            ...
            <p className="mt-6 text-center text-sm text-sage">
              Não tem conta?{' '}
              <Link to="/register" className="text-neon hover:text-cyan font-medium transition-colors">
                Crie uma agora
              </Link>
            </p>
          </div>
